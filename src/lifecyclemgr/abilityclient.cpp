...
void AbilityClient::Start(const abilityUnit::StartInfo &start_info)
{
    ...
    // threads["start"] = std::async(std::launch::async, &abilityUnit::Ability::Stub::Start, stub_,
    //                                 &context, start_info, &response);
    // threads["start"] = std::thread(&abilityUnit::Ability::Stub::Start, stub_,
    //                                 &context, start_info, &response);
...
void AbilityClient::Connect(const abilityUnit::ConnectInfo &connect_info)
{
    abilityUnit::Response response;
    ClientContext context;
    // threads["connect"] = std::async(std::launch::async, &abilityUnit::Ability::Stub::Connect, stub_,
    //                                 &context, connect_info, &response);
    // threads["connect"] = std::thread(&abilityUnit::Ability::Stub::Connect, stub_,
    //                                 &context, connect_info, &response);
...
void AbilityClient::Disconnect(const abilityUnit::DisconnectInfo &disconnect_info)
{
    abilityUnit::Response response;
    ClientContext context;
    // threads["disconnect"] = std::async(std::launch::async, &abilityUnit::Ability::Stub::Disconnect, stub_,
    //                                 &context, disconnect_info, &response);
    // threads["disconnect"] = std::thread(&abilityUnit::Ability::Stub::Disconnect, stub_,
    //                                 &context, disconnect_info, &response);
...
void AbilityClient::Terminate(const abilityUnit::TerminateInfo &terminate_info)
{
    abilityUnit::Response response;
    ClientContext context;
    // threads["terminate"] = std::async(std::launch::async, &abilityUnit::Ability::Stub::Terminate, stub_,
    //                                 &context, terminate_info, &response);
    // threads["terminate"] = std::thread(&abilityUnit::Ability::Stub::Terminate, stub_,
    //                                 &context, terminate_info, &response);
