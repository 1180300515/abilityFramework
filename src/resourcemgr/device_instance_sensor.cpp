 ...
 *
 * File: device_instance_sensor.cpp
 * Description: device_instance_sensor.cpp
 * Version: V1.0.0
 * Date: 2023/08/24
...
bool SensorInstance::updateInstance(const Json::Value &jnode) { return FromJson(jnode); }

std::string SensorInstance::getInstanceVersion() const { return spec.version; }
