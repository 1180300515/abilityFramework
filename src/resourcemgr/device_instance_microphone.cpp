 ...
 *
 * File: device_instance_microphone.cpp
 * Description: device_instance_microphone.cpp
 * Version: V1.0.0
 * Date: 2023/08/24
...
std::string MicrophoneInstance::GetHardwareIdentifier() const { return spec.hardwareidentifier; }
...
bool MicrophoneInstance::updateInstance(const Json::Value &jnode) { return FromJson(jnode); }

std::string MicrophoneInstance::getInstanceVersion() const { return spec.version; }
