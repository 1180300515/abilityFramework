 ...
 *
 * File: device_instance_loudspeaker.cpp
 * Description: device_instance_loudspeaker.cpp
 * Version: V1.0.0
 * Date: 2023/08/24
...
std::string LoudspeakerInstance::GetHardwareIdentifier() const { return spec.hardwareidentifier; }
...
bool LoudspeakerInstance::updateInstance(const Json::Value &jnode) { return FromJson(jnode); }

std::string LoudspeakerInstance::getInstanceVersion() const { return spec.version; }
