...
bool LoudspeakerInstance::UnMarshal(std::string source)
{
    ...
    spec.properties.channelNumber = std::stoi(jnode["spec"]["properties"]["channelNumber"].asString());
    spec.properties.bitWidth = std::stoi(jnode["spec"]["properties"]["bitWidth"].asString());
