...
std::string AbilityRelationManager::GetAbilitySupport() {
  ...
  auto treearraywithdevice =
      this->generateDependTreeArrayWithDevices(treearray);

  return treearraywithdevice.ToJson().toStyledString();
}

DependTreeArray AbilityRelationManager::generateDependTreeArray(
...
DependTreeArray AbilityRelationManager::generateDependTreeArrayWithDevices(
...
void AbilityRelationManager::generateNodes(const TreeNode &node,
                                           DependTreeArray *treeArray) {
...
std::vector<std::vector<std::string>> AbilityRelationManager::cartesianProduct(
