 ...
 *
 * File: test_ability_depend_tree_with_devices.cpp
 * Description: test_ability_depend_tree_with_devices.cpp
 * Version: V1.0.0
 * Date: 2023/08/24
...
int main(int argc, char **argv)
{
    ...
    if ((dir = opendir(ABILITY_FILE_PATH)) != NULL) {
        ...
        std::cout << "Could not open directory : " << ABILITY_FILE_PATH << std::endl;
    }
